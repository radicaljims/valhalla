...
# docker run --name postgres-9.5 -p 5555:5432 --volumes-from postgres-9.5-data postgres-9.5
docker run -d --name postgres-9.5 -p 5555:5432 --volumes-from postgres-9.5-data postgres-9.5
